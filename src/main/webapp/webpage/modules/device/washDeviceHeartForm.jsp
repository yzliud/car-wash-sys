...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="washDeviceHeart" action="${ctx}/device/washDeviceHeart/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<tr>
					...
					<td class="width-35">
						<input id="operatorTime" name="operatorTime" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${washDeviceHeart.operatorTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
					</td>
				</tr>
		 	</tbody>
		</table>
