...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="washSetMeal" action="${ctx}/meal/washSetMeal/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="marketPrice" htmlEscape="false" maxlength="10"    class="form-control required number"/>
					</td>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>销售价：</label></td>
					<td class="width-35">
						<form:input path="salePrice" htmlEscape="false" maxlength="10"    class="form-control required number"/>
					</td>
				</tr>
				<tr>
